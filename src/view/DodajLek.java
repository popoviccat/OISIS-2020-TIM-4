				...
				try {
	        		...
	        		if( !(tfSifra.getText().equals("") || tfIme.getText().equals("") || tfProiz.getText().equals("") || tfCena.getText().equals("")) ) {
			        	if (error == false) {
			                ...
			                dispose();
			                JOptionPane.showMessageDialog(DodajLek.this, "Molimo ponovo otvorite tab kako biste videli azuriran prikaz tabele.", "Azuriranje prikaza", JOptionPane.INFORMATION_MESSAGE);
			        	} else {
			        		System.out.println(error);
			        		tfSifra.setText("");
