...
public class CreateTableIzvestaj extends JPanel{
	...
	public void CreateTableIzvestaj(ArrayList<Stavka> prodatiLekovi) throws ClassNotFoundException, IOException {
	...
	public void initTable(ArrayList<Stavka> prodatiLekovi) throws ClassNotFoundException, IOException {
		
		int size = prodatiLekovi.size();
		Object[][] rowData = new Object[size][7];
		for (int i=0; i<size; i++) {
			rowData[i][0] = prodatiLekovi.get(i).getLek().getSifra();
